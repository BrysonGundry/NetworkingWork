# Bryson Gundry
# 10/25/2019 - Project 3 - IRCClient
...
class IRCClient(object):
    ...
    def connect_to_server(self):
        serverPortInt = int(self.serverport)
        self.client_socket = socket(AF_INET, SOCK_STREAM)
        self.client_socket.connect((self.serveraddr, serverPortInt))
    ...
    def quit(self, quit_message=None):
        if quit_message is None:
            quit_message = "QUIT :" + self.nick + " has quit"
            self.send_message_to_server(quit_message)
        else:
